...
exports.default = (function (name) {
    ...
    try {
        var content = art_template_1.default(path_1.join(__dirname, '../../../templates', 'directives.ts'), { name: trueName });
        var dest = "src/" + basePath + "/" + trueName + ".ts";
